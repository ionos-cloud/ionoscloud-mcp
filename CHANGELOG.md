...
- The reserved-but-unimplemented `router` load mode was renamed to `dynamic` (it was never shipped). Setting `router` now logs a rename hint and falls back to `eager`.
