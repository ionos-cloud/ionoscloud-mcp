...
const (
	...
	// the full catalog at runtime, so the client's tool list never changes. For
	// clients with hard tool caps (e.g. Cursor 40, Windsurf 100); Claude Code should stay eager.
