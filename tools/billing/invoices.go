...
func RegisterInvoiceTools(server *mcp.Server, client *sdk.APIClient) {
	...
	mcp.AddTool(server, &mcp.Tool{
		...
		Description: "Get the detailed line-item breakdown for a specific invoice by ID. Use billing_invoices first to find available invoice IDs. For FOCUS v1.3 compliant output, read resource ionos://billing/focus-v1.3.",
