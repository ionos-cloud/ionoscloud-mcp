...
| `date_start` | string | No | Inclusive start date in `YYYY-MM-DD` format (e.g. `2026-05-01`) |
| `date_end` | string | No | Inclusive end date in `YYYY-MM-DD` format (e.g. `2026-05-11`) |
